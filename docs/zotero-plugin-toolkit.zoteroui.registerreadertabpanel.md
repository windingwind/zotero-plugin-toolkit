...
[Home](./index.md) &gt; [zotero-plugin-toolkit](./zotero-plugin-toolkit.md) &gt; [ZoteroUI](./zotero-plugin-toolkit.zoteroui.md) &gt; [registerReaderTabPanel](./zotero-plugin-toolkit.zoteroui.registerreadertabpanel.md)

## ZoteroUI.registerReaderTabPanel() method
...
```typescript
registerReaderTabPanel(tabLabel: string, renderPanelHook: (panel: XUL.TabPanel | undefined, ownerDeck: XUL.Deck, ownerWindow: Window, readerInstance: _ZoteroReaderInstance) => void, options?: {
        tabId?: string;
        panelId?: string;
        targetIndex?: number;
        selectPanel?: boolean;
